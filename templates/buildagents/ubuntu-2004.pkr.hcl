...
build {
  ...
  provisioner "shell" {
    ...
    execute_command  = "sudo sh -c '{{ .Vars }} {{ .Path }}'"
    scripts          = ["${path.root}/lib/virtual-environments/images/linux/scripts/installers/azcopy.sh",
...
"${path.root}/lib/virtual-environments/images/linux/scripts/installers/erlang.sh",
...
"${path.root}/lib/virtual-environments/images/linux/scripts/installers/hhvm.sh",
...
"${path.root}/lib/virtual-environments/images/linux/scripts/installers/phantomjs.sh",
...
"${path.root}/lib/virtual-environments/images/linux/scripts/installers/mongodb.sh",
